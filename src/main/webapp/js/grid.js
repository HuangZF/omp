...
//			window.location.href("login.jsp?message="+encodeURIComponent("您的账号已经在别处登录，请确认后重新登录！"));
	...
	// 2013-01-15 CHL DELETE 【代码整理】转移到showMenu.js的changeMainPageCss方法  START
//	function changeTheme(newTheme) {
//		if (newTheme=='showcase'){
//			var themePathPrefix = "templates/themes/";
//		}else {
////			var themeHref = $('#jquery_theme_link').attr('href');
//			var themePathPrefix = "templates/themes/";
//		}
//
//		//$('#jquery_theme_link').attr('href',themePathPrefix+newTheme+'/jquery-ui.css');
//		$(parent.mainFrame.document).find('#jquery_theme_link').attr('href',themePathPrefix+newTheme+'/jquery-ui.css');
//	}; 
	// 2013-01-15 CHL DELETE 【代码整理】转移到showMenu.js的changeMainPageCss方法  END
 ...
 // 2012-07-26 CHL DELETE 【V3.6.2需求67】页面可以复制  START
 /*
 ...
 */
 // 2012-07-26 CHL DELETE 【V3.6.2需求67】页面可以复制  END
...
//2012-05-04 add by hzf -通用trim()-start
String.prototype.trim=function() {  
    return this.replace(/(^\s*)|(\s*$)/g,'');  
};
//2012-05-04 add by hzf -通用trim()-end


//2012-05-18 add by my -【其他】解决点开2个子表时，不能正常添加-start
//编辑子列表参数
...
//2012-05-18 add by my -【其他】转移grid.js里面-end